...
namespace FitnessAI.Infrastructure.Migrations
{
    ...
    [Migration("20260610123013_AddUserProfile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessAI.Core.Entities.MealPlan", b =>
                {
            ...
            modelBuilder.Entity("FitnessAI.Core.Entities.Progress", b =>
                {
            ...
            modelBuilder.Entity("FitnessAI.Core.Entities.UserProfile", b =>
                {
            ...
            modelBuilder.Entity("FitnessAI.Core.Entities.MealPlan", b =>
                {
                    b.HasOne("FitnessAI.Core.Entities.User", "User")
                        .WithMany("MealPlans")
            ...
            modelBuilder.Entity("FitnessAI.Core.Entities.UserProfile", b =>
                {
                    b.HasOne("FitnessAI.Core.Entities.User", "User")
                        .WithOne("UserProfile")
                        .HasForeignKey("FitnessAI.Core.Entities.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
